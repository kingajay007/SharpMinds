...
namespace SharpMinds.WebService.Data
{
    ...
    public partial class SharpMindsContext : DbContext
    {
        public SharpMindsContext()
            : base("name=SharpMindsContext")
        {
        }
        ...
        [DbFunction("SharpMindsContext", "GetQuestionsByCategory")]
        public virtual IQueryable<GetQuestionsByCategory_Result> GetQuestionsByCategory(Nullable<int> categoryId)
        {
            var categoryIdParameter = categoryId.HasValue ?
                new ObjectParameter("CategoryId", categoryId) :
                new ObjectParameter("CategoryId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetQuestionsByCategory_Result>("[SharpMindsContext].[GetQuestionsByCategory](@CategoryId)", categoryIdParameter);
        }
